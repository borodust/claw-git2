...
(defparameter %git::+path-list-separator+ 59)
...
(cffi:defctype %git::size-t :unsigned-long-long)
...
(cffi:defctype %git::time-t :int)

(cffi:defcstruct (%git::time :size 12)
                 (%git::time %git::time-t :offset 0)
                 (%git::offset :int :offset 4)
                 (%git::sign :char :offset 8))
...
(cffi:defcstruct (%git::|C:@SA@GIT-DIFF-OPTIONS| :size 88))
...
(cffi:defcstruct (%git::odb-stream :size 64)
                 ...
                 (%git::received-bytes %git::object-size-t :offset
                  28)
                 (%git::read (:pointer :void) :offset 32)
                 (%git::write (:pointer :void) :offset 40)
                 (%git::finalize-write (:pointer :void) :offset 48)
                 (%git::free (:pointer :void) :offset 56))
