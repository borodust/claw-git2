...
(cffi:defcenum (%git::|C:@EA@GIT-BLAME-FLAG-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-BLOB-FILTER-FLAG-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-BRANCH-T| :int)
               "/home/borodust/devel/repo/claw-git2/src/lib/git2/include/git2/types.h:209:9"
               (:local 1)
               (:remote 2)
               (:all 3))

(cffi:defcenum (%git::|C:@EA@GIT-CERT-SSH-RAW-TYPE-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-CERT-SSH-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-CHECKOUT-NOTIFY-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-CHECKOUT-STRATEGY-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-CLONE-LOCAL-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-CONFIGMAP-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-CREDENTIAL-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-DELTA-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-DIFF-FLAG-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-DIFF-LINE-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-DIFF-OPTION-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-DIFF-STATS-FORMAT-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-DIRECTION| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-ERROR-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-FEATURE-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-FETCH-PRUNE-T| :int)
               "/home/borodust/devel/repo/claw-git2/src/lib/git2/include/git2/remote.h:607:9"
               (:prune-unspecified 0)
               (:prune 1)
               (:no-prune 2))

(cffi:defcenum (%git::|C:@EA@GIT-FILEMODE-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-FILTER-FLAG-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-FILTER-MODE-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-INDEX-ADD-OPTION-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-INDEX-ENTRY-EXTENDED-FLAG-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-INDEX-ENTRY-FLAG-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-LIBGIT2-OPT-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-MERGE-ANALYSIS-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-MERGE-FILE-FAVOR-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-MERGE-FILE-FLAG-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-MERGE-FLAG-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-MERGE-PREFERENCE-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-PROXY-T| :int)
               "/home/borodust/devel/repo/claw-git2/src/lib/git2/include/git2/proxy.h:20:9"
               (:none 0)
               (:auto 1)
               (:specified 2))

(cffi:defcenum (%git::|C:@EA@GIT-REBASE-OPERATION-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-REFERENCE-FORMAT-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-REFERENCE-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-REMOTE-AUTOTAG-OPTION-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-REMOTE-CREATE-FLAGS| :int)
                  "/home/borodust/devel/repo/claw-git2/src/lib/git2/include/git2/remote.h:47:9"
                  (:insteadof 1)
                  (:default-fetchspec 2))

(cffi:defbitfield (%git::|C:@EA@GIT-REPOSITORY-INIT-FLAG-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-REPOSITORY-INIT-MODE-T| :int)
               "/home/borodust/devel/repo/claw-git2/src/lib/git2/include/git2/repository.h:280:9"
               (:umask 0)
               (:group 1533)
               (:all 1535))

(cffi:defcenum (%git::|C:@EA@GIT-REPOSITORY-ITEM-T| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-REPOSITORY-OPEN-FLAG-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-REPOSITORY-STATE-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-STASH-APPLY-FLAGS| :int)
               "/home/borodust/devel/repo/claw-git2/src/lib/git2/include/git2/stash.h:75:9"
               (:default 0)
               (:reinstate-index 1))

(cffi:defcenum (%git::|C:@EA@GIT-STASH-APPLY-PROGRESS-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-STASH-FLAGS| :int)
...
(cffi:defbitfield (%git::|C:@EA@GIT-STATUS-OPT-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-STATUS-SHOW-T| :int)
               "/home/borodust/devel/repo/claw-git2/src/lib/git2/include/git2/status.h:73:9"
               (:index-and-workdir 0)
               (:index-only 1)
               (:workdir-only 2))

(cffi:defcenum (%git::|C:@EA@GIT-STATUS-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-SUBMODULE-RECURSE-T| :int)
               "/home/borodust/devel/repo/claw-git2/src/lib/git2/include/git2/types.h:344:9"
               (:no 0)
               (:yes 1)
               (:ondemand 2))

(cffi:defbitfield (%git::|C:@EA@GIT-SUBMODULE-STATUS-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-SUBMODULE-UPDATE-T| :int)
...
(cffi:defcenum (%git::|C:@EA@GIT-TRACE-LEVEL-T| :int)
